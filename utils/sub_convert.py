...
class sub_convert():
    ...
    def yaml_encode(lines):  # 将 URL 内容转换为 YAML (输出默认 YAML 格式)
        ...
        ssr_cipher = ["aes-128-gcm", "aes-192-gcm", "aes-256-gcm", "aes-128-cfb", "aes-192-cfb", "aes-256-cfb", "aes-128-ctr", "aes-192-ctr", "aes-256-ctr", "rc4-md5", "chacha20-ietf", "xchacha20"]
